...
export const Item = (props) => {
  return (
    ...
    <div className="Item border rounded border-secondary-subtle text-center col-5 col-md-3 col-lg-2 d-flex flex-column my-2 mx-1 mx-md-3 p-0 shadow bg-body-tertiary rounded">
