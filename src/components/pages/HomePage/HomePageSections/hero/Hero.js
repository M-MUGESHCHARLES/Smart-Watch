    ...
    <div id="hero-section">
      <div className="row m-0 hero-row">
        <div className="container col-lg-4 col-md-12 hero-container-left d-flex justify-content-center">
          <div className="container hero-content-left px-5 my-auto mx-auto d-grid justify-content-center ">
        ...
        <div className="container col-lg-4 col-md-12 text-center hero-container-center">
          <WatchCarousel />
        </div>
        <div className="container col-lg-4 col-md-12 text-center hero-container-right d-flex justify-content-center">
